---
name: coograph-search
description: Fast read-only codebase search and Q&A with file:line evidence, code-graph first. Depth levels: quick, medium, thorough. Use to answer where/what/how questions about the code.
---
