---
name: coograph-review
description: Strict read-only review of the current changes for spec compliance, convention violations, logic bugs, and architecture. Every finding cites a verbatim quote from a fresh file read. Use after implementation, before declaring done.
---
