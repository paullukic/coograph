---
name: coograph-verify
description: Evidence-based completion check. Runs build, tests, and diagnostics itself and validates acceptance criteria, ending in a PASS / FAIL / INCOMPLETE verdict. Use when work is claimed complete.
---
